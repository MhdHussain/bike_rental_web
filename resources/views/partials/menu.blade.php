<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('bike_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.bikes.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/bikes") || request()->is("admin/bikes/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-bicycle c-sidebar-nav-icon">
